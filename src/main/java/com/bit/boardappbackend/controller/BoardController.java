...
public class BoardController {
    ...
    public ResponseEntity<?> post(@RequestPart("boardDto") BoardDto boardDto,
        ...
        try {
            ...
            log.info("post boardDto: {}", boardDtoList);
    ...
    public ResponseEntity<?> getBoards(@RequestParam("searchCondition") String searchCondition,
        ...
        try {
            ...
            log.info("getBoards boardDtoList: {}", boardDtoList);
    ...
    public ResponseEntity<?> modify(@RequestPart("boardDto") BoardDto boardDto,
        ...
        try {
            ...
            BoardDto modifiedBoardDto = boardService.modify(boardDto, uploadFiles, changeFiles,
                    originFiles, customUserDetails.getMember());
